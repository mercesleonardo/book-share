            ...
            <div class="p-6 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                <form method="POST" action="{{ route('posts.update', $post) }}" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <x-text-input id="title" name="title" class="w-full" value="{{ old('title', $post->title) }}" required />
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <x-textarea-input id="description" name="description">{{ old('description', $post->description) }}</x-textarea-input>
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        @if($post->image)
                            <div class="mb-2">
                                <img src="{{ asset('storage/' . $post->image) }}" alt="Current" class="h-20 rounded object-cover" />
                            </div>
                        @endif
